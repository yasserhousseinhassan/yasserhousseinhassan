...
[![Role](https://img.shields.io/badge/Data%20Systems%20Developer-Hypercube-0A0A0A?style=for-the-badge&logo=googlecloud&logoColor=4F46E5&labelColor=0A0A0A&color=4F46E5)](#experience)
[![Background](https://img.shields.io/badge/Background-Maths%20%26%20Quant%20Finance-4F46E5?style=for-the-badge&logo=scikitlearn&logoColor=white&labelColor=0A0A0A)](#academic-background)
[![Stack](https://img.shields.io/badge/Stack-Python%20%C2%B7%20React%20%C2%B7%20Flutter%20%C2%B7%20SQL-3776AB?style=for-the-badge&logo=python&logoColor=white&labelColor=0A0A0A)](#tech-stack)
[![Passion](https://img.shields.io/badge/Passion-FiveM%20Systems-FF4655?style=for-the-badge&logo=fivem&logoColor=white&labelColor=0A0A0A)](#passion--fivem-game-systems)
...
[![GitHub followers](https://img.shields.io/github/followers/yasserhousseinhassan?style=flat-square&color=4F46E5&labelColor=0A0A0A&logo=github&logoColor=white)](https://github.com/yasserhousseinhassan)
[![GitHub Stars](https://img.shields.io/github/stars/yasserhousseinhassan?style=flat-square&color=FFC107&labelColor=0A0A0A&logo=github&logoColor=white)](https://github.com/yasserhousseinhassan?tab=stars)
...
À côté de ce socle académique, je développe par **passion** des systèmes de jeu avancés pour serveurs **FiveM** — un terrain d'application idéal pour conjuguer rigueur d'ingénieur, temps réel et haute performance.

```python
class Yasser:
    background  = "MSc Applied Mathematics — Quant Finance & Logistics"
    expertise   = ["Modeling", "Quantitative Finance", "Optimization", "Data Systems"]
    quant_stack = ["Python", "MATLAB", "SQL", "EViews", "CPLEX"]
    dev_stack   = ["React", "Flutter", "PHP", "JavaScript", "TypeScript"]
    mindset     = "Rigueur mathématique · Pensée systèmes · Données réelles"
    passion     = ["FiveM game systems", "Lua / JavaScript", "Server performance"]
```

- **Identité** — Ingénieur en mathématiques appliquées : modélisation, finance quantitative, optimisation
...
- **Passion** — Scripting FiveM (Lua/JS) : la même rigueur appliquée au game dev & aux architectures multijoueurs
...
![EViews](https://img.shields.io/badge/EViews-1E3A8A?style=for-the-badge&logo=rstudioide&logoColor=white)
...
![ESX](https://img.shields.io/badge/ESX%20%2F%20QBCore-1E1E1E?style=for-the-badge&logo=cplusplusbuilder&logoColor=white)
![NUI](https://img.shields.io/badge/NUI-HTML%20%2F%20JS%20%2F%20React-61DAFB?style=for-the-badge&logo=react&logoColor=black)
...
**Formation**
- **Master 2 — Ingénierie Mathématique : Finance & Logistique (IMFL)** · Université Le Havre Normandie · France · 2024 – 2025
- **Master 1 — Mathématiques & Applications** · Université Le Havre Normandie · France · 2023 – 2024
- **Licence de Mathématiques** · Université de Djibouti · Djibouti · 2019 – 2022
...
### [Optimisation de Tournées — VRP](https://github.com/yasserhousseinhassan/optimisation-tournees-vehicules-vrp)
...
**Développement Web**
- **Web Development Mastery: HTML, CSS & JavaScript Fundamentals** — *Board Infinity* (Coursera, 2026) · HTML5, CSS (Flexbox/Grid/Bootstrap), JS, React, UX/UI
...
> **Djibouti** · **Mars 2026 — Aujourd'hui**
...
- **Approche quantitative** — application de méthodes de modélisation et d'optimisation (Python/SQL) à des problématiques métier réelles
...
### [ys_shopcreator_premium](https://github.com/yasserhousseinhassan/ys_shopcreator_premium) `🆕 nouveau`
**Créateur de boutiques multi-framework**
> Ressource FiveM avancée pour créer et gérer des boutiques en jeu : bridge multi-framework (ESX/QBCore), interface NUI moderne, persistance SQL et support multi-langue (locales).

`Lua` · `Bridge` · `NUI` · `SQL` · `React`  
**Production-ready & Actif**
...
[![Voir tous mes repos](https://img.shields.io/badge/Voir%20tous%20les%20projets-0A0A0A?style=for-the-badge&logo=github&logoColor=white)](https://github.com/yasserhousseinhassan?tab=repositories)
...
> Un script n'est pas qu'un fichier — c'est un composant d'un système plus large.

J'aborde chaque fonctionnalité avec une logique d'**ingénierie système** :

| Principe | Application concrète |
| :--- | :--- |
| **Modularité** | Resources découplées, configs externalisées, exports propres |
| **Performance** | Boucles optimisées, requêtes DB batchées, zéro waste de tick |
| **Scalabilité** | Code qui tient la charge de 10 à 1000+ joueurs simultanés |
| **Robustesse** | Validation serveur, anti-exploit, gestion d'erreurs explicite |
| **Maintenabilité** | Naming cohérent, documentation, structure prévisible |
...
<img src="https://streak-stats.demolab.com/?user=yasserhousseinhassan&theme=tokyonight&hide_border=true&stroke=4F46E5&ring=4F46E5&fire=FF4655&currStreakLabel=4F46E5" alt="GitHub Streak" />
...
- **Pont maths / code** — Appliquer les méthodes quantitatives à des problématiques concrètes (data systems, optimisation)
- **FiveM (passion)** — `ys_shopcreator_premium` (créateur de boutiques multi-framework) et architectures multijoueurs haute performance
- **Veille continue** — IA / Data Science, Cloud et outils quantitatifs modernes
...
[![GitHub](https://img.shields.io/badge/GitHub-yasserhousseinhassan-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/yasserhousseinhassan)
[![Email](https://img.shields.io/badge/Email-yasserhousseinhassan1%40gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:yasserhousseinhassan1@gmail.com)
[![Discord](https://img.shields.io/badge/Discord-Me%20contacter-5865F2?style=for-the-badge&logo=discord&logoColor=white)](https://discord.com/users/1269146158928760897)
...
*N'hésitez pas à explorer mes dépôts et à laisser une ⭐ si mon travail vous inspire !*

<br/>

![Footer](https://img.shields.io/badge/Built%20with-Maths%2C%20Python%20%26%20Café-4F46E5?style=for-the-badge&logo=coffeescript&logoColor=white&labelColor=0A0A0A)
